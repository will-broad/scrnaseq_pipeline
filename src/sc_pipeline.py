...
sample_tracking_file = os.getenv("SAMPLE_TRACKING_FILE", default="../data/042624_batch4_multiome_count_sampletracker.csv")
...
cellranger_arc_version = os.getenv("CELLRANGER_ARC_VERSION", default="2.0.2.custom-max-cell")
"""
