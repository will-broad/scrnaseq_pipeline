...
sample_tracking_file = os.getenv("SAMPLE_TRACKING_FILE", default="../data/120423_batch4_gex_count_sampletracker.csv")
...
steps_to_run = os.getenv("STEPS", default="COUNT,CELLBENDER").split(',')
