...
sample_tracking_file = os.getenv("SAMPLE_TRACKING_FILE", default="../data/041423_batches_gex_sampletracker.csv")
...
steps_to_run = os.getenv("STEPS", default="MKFASTQ,COUNT,CELLBENDER").split(',')
