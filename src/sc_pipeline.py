...
sample_tracking_file = os.getenv("SAMPLE_TRACKING_FILE", default="../data/053123_batch3_gex_count_sampletracker.csv")
...
steps_to_run = os.getenv("STEPS", default="COUNT,CELLBENDER,CELLBENDER_CUMULUS").split(',')
