...
sample_tracking_file = os.getenv("SAMPLE_TRACKING_FILE", default="../data/052323_batch3_gex_sampletracker.csv")
...
steps_to_run = os.getenv("STEPS", default="MKFASTQ,COUNT,CELLBENDER,CELLBENDER_CUMULUS").split(',')
