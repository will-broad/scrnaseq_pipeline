...
sample_tracking_file="${gcp_bucket_basedir}/012523_batch2_gex_sampletracker.csv"
...
steps="CELLBENDER,CELLBENDER_CUMULUS"
mkfastq_memory="120G"
...
dsub --provider google-cls-v2 --project "microbiome-xavier" --regions us-east1 \
  ...
  --command "wget https://github.com/will-broad/scrnaseq_pipeline/archive/gex_atac.zip && unzip gex_atac.zip && cd scrnaseq_pipeline-gex_atac/src && python sc_pipeline.py" \
