...
dsub --provider google-cls-v2 --project "microbiome-xavier" --regions us-east1 \
  ...
  --command "wget https://github.com/dan-broad/scrnaseq_pipeline/archive/multiome.zip && unzip multiome.zip && cd scrnaseq_pipeline-master/src && python sc_pipeline.py" \
