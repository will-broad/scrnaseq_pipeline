...
sample_tracking_file="${gcp_bucket_basedir}/041724_batches_rerun_gex_count_sampletracker.csv"
...
dsub --provider google-cls-v2 --project "microbiome-xavier" --regions us-east1 \
  ...
  --image "gcr.io/microbiome-xavier/conda-alto" --disk-size '128' --timeout '2d'\
