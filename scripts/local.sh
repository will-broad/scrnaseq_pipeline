...
sample_tracking_file="${gcp_bucket_basedir}/022723_batch2_gex_sampletracker.csv"
...
steps="MKFASTQ,COUNT,CELLBENDER,CELLBENDER_CUMULUS"
mkfastq_memory="256G"
...
dsub --provider google-cls-v2 --project "microbiome-xavier" --regions us-east1 \
  ...
  --command "wget https://github.com/will-broad/scrnaseq_pipeline/archive/gex.zip && unzip gex_atac.zip && cd scrnaseq_pipeline-gex/src && python sc_pipeline.py" \
