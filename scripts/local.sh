...
sample_tracking_file="${gcp_bucket_basedir}/081023_demux_gex_cc_sampletracker.csv"
...
dsub --provider google-cls-v2 --project "microbiome-xavier" --regions us-east1 \
  ...
  --command "wget --no-check-certificate https://github.com/will-broad/scrnaseq_pipeline/archive/gex.zip && unzip gex.zip && cd scrnaseq_pipeline-gex/src && python sc_pipeline.py" \
